...
// File: @pancakeswap/v3-core/contracts/libraries/TickBitmap.sol
...
// File: src/v3-periphery/contracts/interfaces/IQuoterV2.sol
...
library PoolAddress {
    ...
    // bytes32 internal constant POOL_INIT_CODE_HASH = 0x0838fb160c8314a8a48509d4c5b7d032560c924298fc8f808034b4637eb42bc0;
        bytes32 internal constant POOL_INIT_CODE_HASH = 0xacdd560bec24c2241d44343ced235273a9abaa0f6d115fa3204dca05dc84839f;
...
// File: src/v3-periphery/contracts/libraries/PoolTicksCounter.sol
...
// File: src/v3-periphery/contracts/lens/QuoterV2.sol
...
contract QuoterV2 is IQuoterV2, IPancakeV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) public view returns (IPancakeV3Pool) {
